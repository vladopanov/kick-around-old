...
{
    public class PlayerRejectedGroupNotification : Notification
    {
        ...
        public override string ToString()
        {
            ...
            sb.AppendLine($">User <strong>{this.Sender.UserName}</strong> has rejected your request to join group <strong>{this.Group.Name}</strong>.</div>");
            sb.Append(
